...
import com.samantha.spring6restmvc.config.SpringSecConfig;
...
class BeerControllerTest {
    ...
    public static final String USERNAME = "atomicstructure";
    public static final String PASSWORD = "Floating1!";
